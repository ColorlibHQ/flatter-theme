...
// enqueue css
function flatter_common_custom_css(){
    
    wp_enqueue_style( 'flatter-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= flatter_opt( 'flatter_theme_color' );
		$themeSecColor     		  	= '';
		$bookBtnBgColor       		= flatter_opt( 'flatter_book_btn_bg_color' ) != '#ffffff' ? flatter_opt('flatter_book_btn_bg_color') : '';
		$bookBtnHoverBgColor     	= flatter_opt( 'flatter_book_btn_hvr_color' ) != '#000000' ? flatter_opt('flatter_book_btn_hvr_color') : '';
		$hoverColor     	  	  = flatter_opt( 'flatter_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = flatter_opt( 'flatter_navbar_bg_color' ) != '#082b49' ? flatter_opt( 'flatter_navbar_bg_color') : '';
		$headerTop_col     		  = flatter_opt( 'flatter_top_header_color' );

		$headerTopBg      		  = flatter_opt( 'flatter_top_header_bg_color');
		$headerBg          		  = flatter_opt( 'flatter_header_bg_color') != '#53c9bb' ? flatter_opt( 'flatter_header_bg_color') : $themeColor;
		$menuColor          	  = flatter_opt( 'flatter_header_menu_color' ) != '#ffffff' ? flatter_opt('flatter_header_menu_color') : '';
		$menuHoverColor           = flatter_opt( 'flatter_header_menu_hover_color' ) != '#78b454' ? flatter_opt('flatter_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = flatter_opt( 'flatter_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = flatter_opt( 'flatter_header_drop_menu_bg_color' ) != '#ffffff' ? flatter_opt('flatter_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = flatter_opt( 'flatter_dropdown_menu_color' ) != '#53c9bb' ? flatter_opt('flatter_dropdown_menu_color') : $themeColor;
		$dropMenuHovColor         = flatter_opt( 'flatter_dropdown_menu_hover_bg_color' ) != '#78b454' ? flatter_opt('flatter_dropdown_menu_hover_bg_color') : $themeColor;

		$footerwbgColor     	  = '';
		$footerwHeadColor   	  = flatter_opt('flatter_footer_widget_heading_color');
		$footerwTextColor   	  = flatter_opt('flatter_footer_widget_text_color');
		$footerwanchorcolor 	  = flatter_opt('flatter_footer_widget_anchor_color') != '#ffffff' ? flatter_opt('flatter_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = flatter_opt('flatter_footer_widget_anchor_hover_color') != '#ffffff' ? flatter_opt('flatter_footer_widget_anchor_hover_color') : $themeColor;
		
		$fofbg					  = flatter_opt('flatter_fof_bg_color');
		$foftonecolor			  = flatter_opt('flatter_fof_textone_color');
		$fofttwocolor			  = flatter_opt('flatter_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = flatter_opt('flatter_footer_widget_anchor_color') != '#e5e5e5' ? flatter_opt('flatter_footer_widget_anchor_color') : $themeSecColor;
		$footerAncDefHovColor 	  = $footerwanchorhovcolor != '#bababa' ? $footerwanchorhovcolor : $themeColor;

		$customcss ="			
			.header-area .main-header-area .boxed_btn_white
			{
				color: {$bookBtnBgColor};
				border-color: {$bookBtnBgColor};
			}
			.header-area .main-header-area .boxed_btn_white:hover
			{
			...
			.service_part .single_service_part:hover .single_service_part_iner span, .footer_Part .footer_btn .btn_1:hover, .blog_item_img .blog_item_date
			{
			...
			.footer-area .single-footer-widget p, .footer-area .widget_flatter_newsletter .input-group input, .footer-area .copyright_part_text p, .footer_Part .copyright_part p, .footer-area .footer_2 .social_icon a, .footer_Part .footer_text h2, .footer-area .single-footer-widget .office-location ul li p, .footer .footer_top .footer_widget p, .footer .footer_top .footer_widget .newsletter_text, .footer .copy-right_text .copy_right, .footer_area .copyright_text p, .footer_area .footer_widget .offer_text, .footer_area .footer-bottom .copyright .footer-text
			{
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .flatter_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .flatter_mailchimp_newsletter_widget button
			{
			...
			.single_sidebar_widget.widget_search .boxed-btn:hover, .form-contact .form-group .btn_1:hover, .search-page .backtohome .btn_1:hover, .f0f-content .btn_1:hover, .contact-section .button-contactForm:hover, .comment-form .form-group .boxed-btn:hover {
				color: {$whiteColor} !important;
			}

        ";
       
    wp_add_inline_style( 'flatter-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'flatter_common_custom_css', 50 );