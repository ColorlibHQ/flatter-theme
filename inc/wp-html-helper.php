...
// image default alt
if ( ! function_exists( 'flatter_img_default_alt' ) ) {
	function flatter_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'flatter_img_tag' ) ) {
	function flatter_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = flatter_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'flatter_anchor_tag' ) ) {
	function flatter_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'flatter_heading_tag' ) ) {
	function flatter_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'flatter_paragraph_tag' ) ) {
	function flatter_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'flatter_other_tag' ) ) {
	function flatter_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'flatter_button_element ' ) ) {
	function flatter_button_element( array $args ) {
